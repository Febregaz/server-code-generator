$(document).ready(function () {
	...
	// should delete this method. select a theme to use.
    function switchTheme(themeName) {
    		var href = $('#bs-css').attr('href');
    		var prefix = '';
    		if (href.startsWith('../')) {
    			prefix = '../'
    		}
        if (themeName == 'classic') {
            $('#bs-css').attr('href', prefix + 'plugins/bootstrap/dist/css/bootstrap.min.css');
        } else {
            $('#bs-css').attr('href', prefix + 'css/bootstrap-' + themeName + '.min.css');
        }
